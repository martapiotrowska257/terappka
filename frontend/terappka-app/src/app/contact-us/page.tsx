          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Pn-Pt: 8:00 - 18:00</p>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900">Biuro</h3>
                <p className="text-gray-600 font-medium">
                  ul. Terapeutyczna 15
                </p>
                <p className="text-sm text-gray-500">00-001 Gdańsk</p>
              </div>
            </div>
          </div>
